...
### VeloZip 0.7 for Windows x64

- [Download the complete ZIP package](https://github.com/tklee000/velozip/releases/download/v0.7/velozip-v0.7-windows-x64.zip)
- [View the GitHub release](https://github.com/tklee000/velozip/releases/tag/v0.7)
- [Browse the individual release files](v0.7/)
...
1. Download and extract `velozip-v0.7-windows-x64.zip`.
